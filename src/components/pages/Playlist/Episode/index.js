...
class Episode extends Component {
  ...
  render() {
    let {episode, setCurrentPlaying, guid, currentPlaying, setPlayPauseStatus} = this.props
    ...
    return (
      <div className="flex flex-wrap w-full items-center px-5 pt-3 bg-grey-custom-light">
        <div className="w-1/4 pr-8">
          <div className="w-full h-12 relative bg-center bg-cover" style={{backgroundImage: `url(${episode.image})`}}>
            <div className="flex items-center justify-center black-transparent pin z-10 absolute">
              <FontAwesomeIcon icon={playPauseButton} className="text-white"  onClick={() => {
        ...
        <div className="flex w-3/4 border-b pb-3">
          ...
          <div className="flex items-center justify-end w-1/4">
            ...
            <audio controls className="hidden" ref={audio => (this.audio = audio)}>
